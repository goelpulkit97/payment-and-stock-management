                ...
                <div class="bs-example widget-shadow" data-example-id="bordered-table">
                    ...
                    <table class="table">
                        <form action="clientsearch.php" method="post">
                            <tr>
                                <td> <input type="text" name="key" class="form-control" placeholder="Enter Client Name to Search" required></td>
                        ...
                        ?>
                            <form action="deleteclient.php" id="form<?php echo $row['id']; ?>" method="post">
                                <tr>
                                    ...
                                    <td>
                                        <select name="act" id="act<?php echo $row['id']; ?>" class="form-control">
                                            <option value="0">Delete</option>
                                            <option value="1">Add Amount</option>
                                            <option value="2">Add Receiving</option>
                                        </select>
                                    </td>
                                    <td><input type="button" onclick="dlt<?php echo $row['id'] . "()"; ?>" value="Go" class="btn btn-danger"></td>
                                </tr>
                                <script>
                                    function dlt<?php echo $row['id'] . "()"; ?> {
                                        var act = document.getElementById("act<?php echo $row['id']; ?>").value;
                                        if (act == 0)
