            ...
            <div id="page-wrapper">
                <div class="bs-example widget-shadow" data-example-id="bordered-table">
                    ...
                    <table class="table">
                        ...
                        <?php
                        $sql = "SELECT * FROM nsold where quantity LIKE '%$key%' or client LIKE '%$key%' or date_time LIKE '%$key%' or taker LIKE '%$key%' or carnumber LIKE '%$key%' or category LIKE '%$key%' or scategory LIKE '%$key%'";
